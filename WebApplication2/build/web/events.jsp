...
<html>
<head>
    <title>PetFestHub - All Events</title> <%-- Updated Title --%>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <style>
        /* Your existing CSS styles - Ensure they are complete */
        ...
        .cards { display: flex; flex-wrap: wrap; justify-content: center; gap: 60px; padding: 40px 20px 60px 20px; max-width: 1000px; margin: 0 auto; } /* Adjusted padding */
        .card { flex: 0 1 calc(33.33% - 40px); box-sizing: border-box; background: white; border-radius: 8px; box-shadow: 0 0 5px rgba(0,0,0,0.1); overflow: hidden; margin-bottom: 30px; /* Removed top margin, added bottom */ }
        ...
        .page-title { text-align: center; font-size: 28px; font-weight: bold; margin: 40px 0 20px 0; position: relative; color: #333; } /* Reused style */
...
<header>
    ...
    <nav>
        ...
        <a href="${pageContext.request.contextPath}/ViewEventsServlet">Events</a> <%-- Link to its own servlet --%>
...
<div class="cards">
    <c:choose>
        <%-- Check if the allEvents list (set by ViewEventsServlet) is not empty --%>
        ...
        <%-- If the allEvents list is empty or null --%>
        <c:otherwise>
