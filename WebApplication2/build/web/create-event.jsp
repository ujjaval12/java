...
<%-- Add JSTL core tag library for conditional display --%>
...
<head>
    ...
    <style>
        ...
        input, textarea, button { width: 100%; padding: 12px; margin: 10px 0; font-size: 16px; border-radius: 5px; border: 1px solid #ccc; box-sizing: border-box; /* Added for better width control */ }
        nav { display: flex; }
...
<div class="container">
    ...
    <%-- **** ADDED: Display messages from servlet redirect **** --%>
